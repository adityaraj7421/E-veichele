              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">nawneet Das</h6>
                    <p className="section__description mb-0">14 July, 2022</p>
                    <p className="section__description">
                    Driving my e-rickshaw from Friends Motors gives me peace of mind, knowing it’s built for safety. The stability and braking control are just what I need for a safe ride.
                    </p>
